...
void QGraphicsRectItemWrap::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    setFocus();
...
void QGraphicsRectItemWrap::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    setCursor(Qt::OpenHandCursor);
    setToolTip("test");
}

void QGraphicsRectItemWrap::contextMenuEvent(QGraphicsSceneContextMenuEvent *event)
{
    QMenu menu;
