...
void QGraphicsLineItemWrap::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
    // setFocus();
    setCursor(Qt::ClosedHandCursor);
}

void QGraphicsLineItemWrap::hoverEnterEvent(QGraphicsSceneHoverEvent *event)
{
    setCursor(Qt::OpenHandCursor);
    setToolTip("test");
}

void QGraphicsLineItemWrap::contextMenuEvent(QGraphicsSceneContextMenuEvent *event)
{
    QMenu menu;
